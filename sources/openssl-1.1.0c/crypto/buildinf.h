...
static const char cflags[] = {
    ...
    'O','P','E','N','S','S','L','D','I','R','=','"','\\','"','/','o',
    'p','t','/','s','o','u','r','c','e','s','/','o','p','e','n','s',
    's','l','-','1','.','1','.','0','c','/','.','o','p','e','n','s',
    's','l','/','s','s','l','\\','"','"',' ','-','D','E','N','G','I',
    'N','E','S','D','I','R','=','"','\\','"','/','o','p','t','/','s',
    'o','u','r','c','e','s','/','o','p','e','n','s','s','l','-','1',
    '.','1','.','0','c','/','.','o','p','e','n','s','s','l','/','l',
    'i','b','/','e','n','g','i','n','e','s','-','1','.','1','\\','"',
    '"',' ',' ','-','W','a',',','-','-','n','o','e','x','e','c','s',
    't','a','c','k','\0'
};
#define PLATFORM "platform: linux-x86_64"
#define DATE "built on: Fri Jan 13 02:36:45 2017"
